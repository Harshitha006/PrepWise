...
import { Mail, Lock, ArrowRight, Zap, GraduationCap } from "lucide-react";
            ...
            <Card className="w-full max-w-md border-zinc-800 bg-zinc-900/50 backdrop-blur-xl">
                ...
                <CardContent>
                    <form onSubmit={handleEmailSignIn} className="space-y-4">
                        ...
                        <Button
                            type="submit"
                            className="w-full bg-blue-600 hover:bg-blue-700 h-12 text-lg font-semibold shadow-lg shadow-blue-900/20"
                            disabled={loading}
                        >
                    ...
                    <div className="mt-6">
                        ...
                        <Button
                            variant="outline"
                            className="w-full mt-4 h-12 border-zinc-700 bg-zinc-800/30 hover:bg-zinc-800"
